...
class DataSaverHook:
    ...
    def __call__(self, module, input_batch, output_batch):
        ...
        if self.store_input:
            ...
            # if isinstance(module, QuantBasicTransformerBlock): # in order to capture context // QuantBasicTransformerblock sd에만 있으니까 ldm만 돌릴꺼면 필요없어보임
...
class GetLayerInpOut:
    ...
    def __call__(self, 
        ...
        handle = self.layer.register_forward_hook(self.data_saver) ## with_kwargs 하니까 오류 뜸
